...
import { newAppointment } from '@/api/appointments/new-appointment'
import { selectPatients } from '@/api/patient/select-patients'
import { selectProfessionals } from '@/api/professional/select-professionals'
